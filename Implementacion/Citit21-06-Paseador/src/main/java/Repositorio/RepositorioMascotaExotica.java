...
public class RepositorioMascotaExotica {
    ...
    public Exotico crear(HashMap<String, String> exotico) {
        ...
        Exotico e = new Exotico(exotico.get("nombre"), codigoPostal, exotico.get("descripcion"), permiso, certificadoLegal, certificadoSalud);
    ...
    public void borrar(int id) {
        repositorio.remove(repositorio.stream().filter(exotico -> exotico.getId() == id).findAny().orElseThrow());
    }
