...
public class Responsable extends Usuario {
  ...
  public void		addCuidadores(Cuidador cuidador) { cuidadoresFavoritos.add(cuidador); }
  public void removeCuidadores(Cuidador cuidador) { cuidadoresFavoritos.remove(cuidador); }
}
